...
The subgroup treatment effects should be in a vector. Subgroup effects corresponding to the levels of the same effect modifier should be next to each other with the subgroup effect of the 1 level placed first. Keep a vector that keeps track of the names of the effect modifiers: the subgroup effects vector and the summary study data vector should be in the order of this vector. In our study, the aggregate-level study data is formatted as follows.
