...
In this vignette, we demonstrate how to use `TransportHealth` for interpolated g-computation, a transportability analysis based on network meta-interpolation, for instances where only aggregate data is available for the original study sample.
