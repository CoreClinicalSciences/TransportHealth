...
This can be any of the families that are used in `glm` or one of `"coxph"` or `"survreg"`. The latter options are for survival analysis and will use default options of these methods from the `survival` package.
